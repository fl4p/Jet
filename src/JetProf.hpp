...
enum { JP_TRI_SETUP = 0, JP_TRI_ROWS, JP_TRI_PIX, JP_K_TRI, JP_K_ROWS, JP_EMIT_TRIED, JP_REJ_Z, JP_REJ_SCREEN, JP_REJ_BACKFACE, JP_BAND_WALK, JP_XFORM, JP_SORT, JP_VERTS, JP_OBJ, JP_EMIT, JP_EMIT_CULL, JP_EMIT_BUILD, JP_EMIT_TAIL, JP_N };
